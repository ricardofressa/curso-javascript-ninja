(function () {
  ...
  */
  ...
  var ricardo = new Person('Ricardo', 'Cardoso', 32)
  var joao = new Person('Joao', 'Felipe', 30)
  var maria = new Person('Maria', 'Eduarda', 20)
  console.log(ricardo)
  console.log(joao)
  console.log(maria)
  ...
  */
  ...
  console.log(ricardo.getFullName() + ' agora tem ' + ricardo.addAge(2).getAge() + ' anos.')
